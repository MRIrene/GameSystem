...
namespace RollABall
{
    public class CharacterHandler : MonoBehaviour
    {
        ...
        #region Health
        //max and min health
        // have your health heal over time .. challenge to complete on my own
        ...
        {
            // to make sure that the health is captured at the end of the frame, so we cant go backwards at the start of the next frame
        ...
        private void OnGUI()
        {
            ...
            for (int x = 0; x < 16; x++)
            {
                ...
                // start width position, start height position, size you go across, size you go down
                GUI.Box(new Rect(6 * scrW, 0.5f * scrH, 4 * scrW, 0.5f * scrH), "", healthBar);
